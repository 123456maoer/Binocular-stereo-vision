...
from models.sintel_io import depth_read
import pickle
import numpy as np
from local_utils_main import projective_transform
...
class myImageloader(data.Dataset):
    ...
    def __getitem__(self, index, angle=None, rand=True, tilt=None, tip=None):
        ...
        if self.resize:
            ...
            # left_img  = left_img.crop((0,0,1280,720))
            # right_img = right_img.crop((0,0,1280,720))
